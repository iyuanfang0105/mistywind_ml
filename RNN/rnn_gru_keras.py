...
class KerasGRU(object):
    ...
    def build_model(self):
        ...
        for i in range(self.num_layers):
            m.add(GRU(self.hidden_size, return_sequences=True))
        if self.use_dropout:
            m.add(Dropout(0.5))
...
if __name__ == '__main__':
    ...
    lstm_model = KerasGRU(vocabulary, num_layers=2, hidden_size=500, num_epochs=50, batch_size=20, num_steps=30, model_save_path='./', use_dropout=True)
